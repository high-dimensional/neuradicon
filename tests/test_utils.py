...
@pytest.fixture
def model():
    ner_name = "./models-llm/ner"
    model_name = "./models-llm/negation"
    tokenizer_name = "./models-llm/basemodel"  # "dmis-lab/biobert-v1.1"
...
def test_sectioner():
    tokenizer = "./models-llm/basemodel"  # "dmis-lab/biobert-v1.1"
    model = "./models-llm/segmentation"
