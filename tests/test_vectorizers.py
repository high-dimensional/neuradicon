...
def test_feature_cluster_load():
    clus = FeatureClusterer(3)
    clus.load_from_pickle("./models-llm/path_model_030123_v2")
...
def test_vectorizer():
    ...
    vec.load_from_pickle("./models-llm/path_model_030123_v2")
    nlp = spacy.load(
        "./models-llm/path_model_030123_v2/en_full_neuro_model-1.8/en_full_neuro_model/en_full_neuro_model-1.8"
    )
